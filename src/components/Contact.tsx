...
export default function Contact() {
  ...
  return (
    <section id="contact" className="max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-16 bg-gradient-to-b from-white to-gray-50">
      <motion.div
      ...
      >
        <h3 className="text-2xl md:text-3xl font-bold text-[#355872]">Kontak Kami</h3>
      ...
      >
        <motion.div className="space-y-3 md:space-y-4">
          <motion.div custom={0} variants={contactVariants}>
            <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-[#355872]">
              <CardContent className="p-4 md:p-5 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-700 mt-1">{address}</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
          ...
          <motion.div custom={1} variants={contactVariants}>
            <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-green-600">
              <CardContent className="p-4 md:p-5 flex items-start gap-3">
                <Phone className="text-[#355872] mt-1 flex-shrink-0 w-5 h-5" />
                <div className="flex-1">
                  <h4 className="font-semibold text-sm md:text-base">WhatsApp</h4>
                  <p className="text-xs md:text-sm text-gray-700 mt-1 mb-2">
          ...
          <motion.div custom={2} variants={contactVariants}>
            <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-l-pink-600">
              <CardContent className="p-4 md:p-5 flex items-start gap-3">
                <Instagram className="text-[#355872] mt-1 flex-shrink-0 w-5 h-5" />
                <div className="flex-1">
                  <h4 className="font-semibold text-sm md:text-base">Instagram</h4>
                  <p className="text-xs md:text-sm text-gray-700 mt-1 mb-2">
                    @muriacellular
                  </p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <Card className="overflow-hidden shadow-lg h-64 md:h-96">
